...
class FaceMeshGenerator:
    def __init__(self, mode=True, num_faces=2, min_detection_con=0.5, min_track_con=0.5):
        """
...
def generate_face_mesh(video_path, resizing_factor, save_video=True, filename="Face Mesh.mp4"):
    """
    ...
    try:
        ...
        if save_video:
            ...
            video_dir = r"E:\Eye-Blink-Detection-using-MediaPipe-and-OpenCV\DATA\VIDEOS\OUTPUTS"
